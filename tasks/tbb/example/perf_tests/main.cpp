...
TEST(chernova_n_cannon_matrix_mul_tbb, test_pipeline_run) {
  int n = 1000;
  ...
  task_data_tbb->inputs.emplace_back(reinterpret_cast<uint8_t *>(in_mtrx_a.data()));
  task_data_tbb->inputs_count.emplace_back(in_mtrx_a.size());
  task_data_tbb->inputs.emplace_back(reinterpret_cast<uint8_t *>(in_mtrx_b.data()));
  task_data_tbb->inputs_count.emplace_back(in_mtrx_b.size());
...
TEST(chernova_n_cannon_matrix_mul_tbb, test_task_run) {
  int n = 1000;
